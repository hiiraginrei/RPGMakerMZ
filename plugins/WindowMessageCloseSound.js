...
(() => {
	...
	Window_Message.prototype.terminateMessage = function() {
		...
		var choiceNoSoundFlg = this._choiceListWindow._noSound;
		var numberNoSoundFlg = this._numberInputWindow._noSound;
		var eventNoSoundFlg = this._eventItemWindow._noSound;
